...
function createMenuItem(name, price, category){     //Creating params
    return {name, price, category};                 //returning object with params inside
}
...
*/
  const newArray = {name: "Randy", rating: 5, feedback: "Awesome"}
  console.log(reviews.push(newArray))
  console.log(reviews)
...
function getReviewByIndex(arr, indx) {
  return `${arr[indx].name} gave the restaurant a ${arr[indx].rating} star review, and their feedback was: ${arr[indx].feedback}`
